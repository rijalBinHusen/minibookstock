...
const records = [
  {
    kd_item: "kode",
    nm_item: "itemnya fsldfjoier",
    age: 7,
    newKd_item: "123123123",
    newNm_item: "jika aaa",
    newAge: 9,
  },
  {
    ...
    nm_item: "skdjfwoieur",
    age: 7,
    newKd_item: "skdjfwiuerwoiur",
    newNm_item: "sdfuo74239487",
    newAge: 9,
  },
  {
    kd_item: "sldkjfwiur",
    nm_item: "0293812l3kjdsfdf",
    age: 7,
    newKd_item: "sldkjfwper8w0e9r8",
    newNm_item: "sldkfjwir",
    newAge: 9,
  },
  {
    kd_item: "aqerwer",
    nm_item: "skdjfsl;dnc,zmnclkjsdf",
    age: 7,
    newKd_item: "sdkfjjsldkfjwpoeriu",
    newNm_item: "sdkfhowieur",
    newAge: 9,
  },
  {
    kd_item: "sldkfjwoieur",
    nm_item: "skdfj,mcmdjwoiuer",
    age: 7,
    newKd_item: "lsdkjfcmnvbskdfj",
    newNm_item: "sldkjf0983409234",
    newAge: 9,
  },
  {
    kd_item: "lksdjfpwoeirwer",
    nm_item: "0w98r423 nkjflsdfj",
    age: 7,
    newKd_item: "sldjfpw984023984",
    newNm_item: "sdlkfweiur",
    newAge: 9,
  },
  {
    kd_item: "sdkfj0w9er80w9e",
    nm_item: "lsdkjfowiuer8weur",
    age: 7,
    newKd_item: "sldkfjwper023984",
    newNm_item: "sldfjwpeo9r80293894",
    newAge: 9,
  },
  {
    kd_item: "sdlkjfpweruwioeur",
    nm_item: "skdfjwoieurwoeiur",
    age: 7,
    newKd_item: "sdlf09834984848",
    newNm_item: "sdkfncnc",
    newAge: 9,
  },
];
...
for (const record of records) {
  ...
  describe("update master item", () => {
    it("Should update item", async () => {
      ...
      // {
      //     kd_item: record.newKd_item,
      //     nm_item: record.newNm_item,
      //     age_item: record.newAge,
      //   });
      // find the object from indexeddb by id
